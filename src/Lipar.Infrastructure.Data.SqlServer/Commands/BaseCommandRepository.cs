...
where TDbContext : BaseCommandDbContext
{
    ...
    {
        return _db.Set<TEntity>().SingleOrDefault(c => c.Id == id);
    }
    ...
    {
        return _db.Set<TEntity>().Any(expression);
    }
    ...
    {
        return _db.Set<TEntity>().Any(m => m.Id == id);
    }
    #endregion
    ...
    {
        return await _db.Set<TEntity>().SingleOrDefaultAsync(c => c.Id == id);
    }
